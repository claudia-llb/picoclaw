...
describe("config identity defaults", () => {
  ...
  it("supports provider textChunkLimit config", async () => {
    await withTempHome(async (home) => {
      ...
      expect(cfg.channels?.telegram?.textChunkLimit).toBe(4444);
      expect(cfg.channels?.telegram?.textChunkLimit).toBe(3333);
      expect(cfg.channels?.telegram?.textChunkLimit).toBe(1999);
      expect(cfg.channels?.telegram?.maxLinesPerMessage).toBe(17);
      expect(cfg.channels?.telegram?.textChunkLimit).toBe(2222);
      expect(cfg.channels?.telegram?.textChunkLimit).toBe(1111);
