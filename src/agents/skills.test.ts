...
describe("buildWorkspaceSkillCommandSpecs", () => {
  ...
  it("truncates descriptions longer than 100 characters for Telegram compatibility", async () => {
    const workspaceDir = await makeWorkspace();
    const longDescription =
      "This is a very long description that exceeds Telegram's 100 character limit for slash command descriptions and should be truncated";
    await writeSkill({
